              ...
              <div class="tab-content">
                <div class="tab-pane fade show active" id="tabs_1">
                  <div class="rld-main-search">
                    <div class="row">
                      <div class="rld-single-input col-md-6 col-lg-3">
...
<!--                      <div class="rld-single-select ml-22">
                      ...
                      <div class="col-xl-2 col-lg-2 col-md-4 pl-0">-->
                        <button class="btn btn-yellow" @click="goToSearch()">Search Now</button>
                      </div>
<!--                      <div class="explore__form-checkbox-list filter-block full-filter">
                        <div class="row">
                          <div class="col-lg-4 col-md-6 py-1 pr-30 pl-0">
                            &lt;!&ndash; Form Property Status &ndash;&gt;
                            ...
                            &lt;!&ndash;/ End Form Property Status &ndash;&gt;
                          </div>
                          <div class="col-lg-4 col-md-6 py-1 pr-30 pl-0 ">
                            &lt;!&ndash; Form Bedrooms &ndash;&gt;
                            ...
                            &lt;!&ndash;/ End Form Bedrooms &ndash;&gt;
                          </div>
                          <div class="col-lg-4 col-md-6 py-1 pl-0 pr-0">
                            &lt;!&ndash; Form Bathrooms &ndash;&gt;
                            ...
                            &lt;!&ndash;/ End Form Bathrooms &ndash;&gt;
                          </div>
                          <div class="col-lg-5 col-md-12 col-sm-12 py-1 pr-30 mr-5 sld">
                            &lt;!&ndash; Price Fields &ndash;&gt;
                            <div class="main-search-field-2">
                              &lt;!&ndash; Area Range &ndash;&gt;
...
<!--                <div class="tab-pane fade" id="tabs_2">
                  <div class="rld-main-search">
                    <div class="row">
                      ...
                      <div class="col-sm-12"><span>Advanced Search</span></div>
